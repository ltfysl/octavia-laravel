...
## Now
- [x] Config presets: saveable run parameter profiles with CRUD + settings UI + tests
...
- [x] Round 21: fine-grained API token scopes (prompts:read/write, runs:read/write; scope middleware with implication rules, backward compatible)
...
- [x] **177 Pest tests / 645 assertions green**, Playwright E2E 7 passed, Pint clean, vue-tsc clean, build green
- [x] Round 23: API keys management + usage tracking
- [x] Round 23b: global activity timeline
- [x] Round 23c: leaderboard CSV export
- [x] Round 23d: standalone chat playground (/playground)
- [x] Round 23e: per-user provider keys (settings, LlmManager override, ProcessRunJob wiring)
- [x] Round 23f: AI diff explanation for prompt versions
