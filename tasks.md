...
- [x] **169 Pest tests / 608 assertions green**, Playwright E2E 7 passed, Pint clean, vue-tsc clean, build green
- [x] Round 23: API keys management + usage tracking (`personal_access_tokens` uses log, /settings/api-keys, EN/DE i18n, LogApiUsage middleware)
