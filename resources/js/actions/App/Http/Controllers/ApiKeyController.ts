...
* @see app/Http/Controllers/ApiKeyController.php:49
* @route '/settings/api-keys'
*/
...
* @see app/Http/Controllers/ApiKeyController.php:66
* @route '/settings/api-keys/{token}'
*/
